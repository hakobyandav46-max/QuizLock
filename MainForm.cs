...
namespace QuizLock
{
    public partial class MainForm : Form
    {
        ...
        private void BuildSetupPanel()
        {
            ...
            var lblUrl = new Label { Text = "Microsoft Forms link:", AutoSize = true, Location = new Point(20, 20) };
            _txtUrl.Location = new Point(20, 45);
            _txtUrl.Width = 430;
            _txtUrl.PlaceholderText = "https://forms.office.com/r/xxxxxxxxxx";
            ...
            _btnStart.Location = new Point(20, 270);
            _btnStart.Width = 200;
            _btnStart.Height = 35;
            ...
            _lblStatus.Location = new Point(20, 315);
        ...
        private void BtnStart_Click(object? sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(this, "Please enter a valid Microsoft Forms link (http/https).", "QuizLock",
